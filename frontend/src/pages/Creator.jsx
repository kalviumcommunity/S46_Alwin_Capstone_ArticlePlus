                        ...
                        <div className="flex flex-col gap-6 px-4 pb-6 sm:flex-row sm:px-8 lg:gap-8 lg:px-16">
                            ...
                            <div className="flex flex-col justify-end gap-4">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        className={`flex min-w-28 items-center justify-center gap-3 rounded-full border px-6 py-1 pr-5 text-base font-medium ${
                                            isFollowing
                                    ...
                                    {creator.type === "individual" && (
                                        <div className="flex flex-col gap-3 md:flex-row md:items-center">
                                            <button className="w-fit rounded-full border border-gray-300 px-6 py-1.5 pr-5 text-base font-medium">
                                                Subscriber
                                            </button>
