...
function Navbar() {
    ...
    return (
        <div className="sticky top-0 z-40">
            <div
                className={`flex flex-row items-center justify-between bg-white sm:min-h-12 ${userExists.value ? "pb-3 pt-3" : "pb-4 pt-5"} ${
                    scrolled
                        ? "px-4 !pb-3 !pt-3 sm:px-6 lg:px-12"
                        : "px-4 py-3 sm:px-8 lg:px-16"
                }`}
                id="navbar">
